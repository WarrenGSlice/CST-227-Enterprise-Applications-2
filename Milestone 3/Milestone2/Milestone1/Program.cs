    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!endGame)
            {
                ...
                board.floodFill(row, col); // changed in Milestone 3 to recursivly check and reveal all non-bombed neighbor cells
        ...
        public static void PrintBoardDuringGame()
        {
            ...
            int index; // variable to hold index value of column header
            ...
            for (index = 0; index < cols; index++)
            {
                ...
                Console.Out.Write(string.Format(" {0} |", index));
            } // end of for loop
        ...
        {
            Console.Out.Write("\n|");
            for (int endLine = 0; endLine < number; endLine++)
            {
                Console.Out.Write("---|");
            }
            Console.Out.Write("\n");
        ...
        public static bool WonGame()
        {
            ...
            for (int row = 0; row < rows; row++)
            {
                ...
                {
                    if (!board.grid[row, col].Visited && !board.grid[row, col].HasBomb) isVisited = true;
                } // end of for loop
            } // end of for loop
            return !isVisited;
        }// end of method
