...
namespace Milestone1
{
    ...
    {
        // Variables
        static int Size { get; set; } // Variable to hold board size
        static Cell[,] grid; // Variable to hold the cell grid in a 2-Dimensional Array of the cell object type
        public static int Difficulty { get; set; } // Variable to hold the difficulty level
